...
<div id="ui-opt-area">
    <div id="new-resume">
        ...
        <table class="table-list">
            ...
            <?php if(empty($delivers)){?>
            <tr>
                <td colspan="5"><div>还没有投递过简历，赶快去<a href="http://127.0.0.1/hdjob/index.php/index/search">找找</a>你喜欢的职位吧。</div></td>
            </tr>
            <?php }?>
            <?php if(is_array($delivers)):?><?php  foreach($delivers as $deliver){ ?>
            <tr>
                <td><a href="http://127.0.0.1/hdjob/index.php/index/search/jobs/id/<?php echo $deliver['recruit_id'];?>.html" target="_blank"><?php echo $deliver['recruit_name'];?></a></td>
                <td><a href="http://127.0.0.1/hdjob/index.php/index/index/company/id/<?php echo $deliver['company_id'];?>.html" target="_blank"><?php echo $deliver['company_name'];?></a></td>
                <td><?php echo $deliver['resume_name'];?></td>
                <td><?php echo date('Y-m-d',$deliver['sendtime']);?></td>
                <td><?php if($deliver['is_view']==0){?><span class="waring">查看中</span><?php  }else{ ?><span class="success">已查看</span><?php }?></td>
            </tr>
            <?php }?><?php endif;?>
            <tr>
                <td colspan="2"></td>

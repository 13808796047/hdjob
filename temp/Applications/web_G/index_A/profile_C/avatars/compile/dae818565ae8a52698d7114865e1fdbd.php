...
<div id="ui-opt-area">
    <div class="tabs-nav">
        <ul>
            <li><a href="http://127.0.0.1/hdjob/index.php/index/profile/info">基本资料</a></li>
            <li class="tabs-nav-active"><a href="http://127.0.0.1/hdjob/index.php/index/profile/avatars">个人头像</a></li>
            <li><a href="http://127.0.0.1/hdjob/index.php/index/profile/proAuth">邮箱验证</a></li>
            <li><a href="http://127.0.0.1/hdjob/index.php/index/profile/password">修改密码</a></li>
        </ul>
        <div class="fn-clear"></div>
    </div>
    <div id="new-resume" style="width:400px;margin:25px auto;">
        <form action="http://127.0.0.1/hdjob/index.php/index/profile/avatars" method="post" enctype="multipart/form-data">
        <table>
            <tr>
                <td rowspan="3">
                    <?php if($avatar==''){?>
                    ...
                    <?php  }else{ ?>
                    <img src="http://127.0.0.1//hdjob/<?php echo $avatar;?>" alt="个人头像" />
                    <?php }?>
                </td>
            </tr>
            <tr>
                <th>上传：</th>
                <td><input type="file" name="avatar" class="input-file" id=""></td>
            </tr>
            <tr>
                <th></th>
                <td><button type="submit" class="btn btn-green">修改</button></td>
            </tr>
        </table>
        </form>
    </div>

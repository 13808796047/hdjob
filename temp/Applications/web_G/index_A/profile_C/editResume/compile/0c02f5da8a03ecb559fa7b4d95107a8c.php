...
<div id="ui-opt-area">
    <div id="new-resume">
        ...
        <form action="http://127.0.0.1/hdjob/index.php/index/profile/editResume/id/<?php echo $_GET['id'];?>" method="post" validate="true" enctype="multipart/form-data">
        <table class="table-form">
            <tr>
                <th>简历名称</th>
                <td><input type="text" name="resume_name" validate="{required:true}" value="<?php echo $info['resume_name'];?>" /><span>简历名称将作为企业的检索条件</span></td>
            </tr>
            <tr>
                <th>简历风格</th>
                <td><select name="style" validate="{required:true}">
                        ...
                        <option value="<?php echo $value['dir_name'];?>" <?php if($value['dir_name']==$info['style']){?>selected<?php }?>><?php echo $value['name'];?></option>
                        <?php }?><?php endif;?>
                    </select></td>
            </tr>
            <tr>
                <th>简历头像</th>
                <td><?php if(empty($info['avatar'])){?><img src="http://127.0.0.1/hdjob/templates/default/images/no_photo.gif" alt=""><?php  }else{ ?><img src="http://127.0.0.1//hdjob/<?php echo $info['avatar'];?>" alt="简历头像"><?php }?>
            ...
            <tr class="avatar-type fn-hide" id="avatar_info">
                <th></th>
                <td><?php if(empty($avatar)){?>
                    <span>你还没有设置个人头像，马上<a href="http://127.0.0.1/hdjob/index.php/index/profile/avatars">设置</a>，或使用上传新头像</span>
                    <?php  }else{ ?>
                        <img src="http://127.0.0.1//hdjob/<?php echo $avatar;?>" alt="">
                        <input type="hidden" name="avatar" value="<?php echo $avatar;?>" disabled>
                    <?php }?></td>
            </tr>
            ...
            <tr>
                ...
                <td>
                    ...
                    <label><input type="radio" name="open" value="0" <?php if($info['open']==0){?>checked<?php }?>>不公开</label>
                </td>
            </tr>
            <tr>
                <th></th>
